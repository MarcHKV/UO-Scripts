...
namespace Server.Items
{
    public abstract class BaseArmor : Item, IScissorable, IFactionItem, ICraftable, IWearableDurability, IResource, ISetItem, IVvVItem, IOwnerRestricted, ITalismanProtection, IEngravable, IArtifact, ICombatEquipment, IQuality
    {
        ...
        */
        ...
        public override int PhysicalResistance { get { return ((m_PhysicalResistance != -1) ? m_PhysicalResistance : (BasePhysicalResistance + GetProtOffset() + GetResourceAttrs(m_Resource).ArmorPhysicalResist + m_PhysicalBonus)); } }
        public override int FireResistance { get { return ((m_FireResistance != -1) ? m_FireResistance : (BaseFireResistance + GetProtOffset() + GetResourceAttrs(m_Resource).ArmorFireResist + m_FireBonus)); } }
        public override int ColdResistance { get { return ((m_ColdResistance != -1) ? m_ColdResistance : (BaseColdResistance + GetProtOffset() + GetResourceAttrs(m_Resource).ArmorColdResist + m_ColdBonus)); } }
        public override int PoisonResistance { get { return ((m_PoisonResistance != -1) ? m_PoisonResistance : (BasePoisonResistance + GetProtOffset() + GetResourceAttrs(m_Resource).ArmorPoisonResist + m_PoisonBonus)); } }
        public override int EnergyResistance { get { return ((m_EnergyResistance != -1) ? m_EnergyResistance : (BaseEnergyResistance + GetProtOffset() + GetResourceAttrs(m_Resource).ArmorEnergyResist + m_EnergyBonus)); } }
        //daat99 OWLTR end
                ...
                case 0:
                    {
                        ...
                        else
                        {
                            ...
                            switch ( reader.ReadInt() )
                            {
                                ...
                                case 9:
                                    info = OreInfo.Blaze; break;
                                case 10:
                                    info = OreInfo.Ice; break;
                                case 11:
                                    info = OreInfo.Toxic; break;
                                case 12:
                                    info = OreInfo.Electrum; break;
                                case 13:
                                    info = OreInfo.Platinum; break;
