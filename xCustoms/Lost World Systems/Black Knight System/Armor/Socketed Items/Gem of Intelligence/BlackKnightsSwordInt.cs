...
{
	public class BlackKnightsSwordInt : VikingSword
	{
		...
		public BlackKnightsSwordInt( Serial serial ) : base( serial )
		{
		}
...
public override void GetProperties( ObjectPropertyList list )
 ...
 list.Add( "<BASEFONT COLOR=#FD8801>Phase 4<BR><BASEFONT COLOR=#E0FA76>Socket: <BASEFONT COLOR=#FBE70A>Gem of Intelligence<BASEFONT COLOR=#68FCAD><br>+5% Attack Chance" );
 } 
	}
}