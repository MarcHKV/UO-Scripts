...
{
	public class BlackKnightsBreastplateMag : PlateChest
	{
		...
		[Constructable]
		public BlackKnightsBreastplateMag()
		{
		...
		public BlackKnightsBreastplateMag( Serial serial ) : base( serial )
		{
		}
...
public override void GetProperties( ObjectPropertyList list )
 ...
 list.Add( "<BASEFONT COLOR=#FD8801>Phase 4<BR><BASEFONT COLOR=#E0FA76>Socket: <BASEFONT COLOR=#B40486>Gem of Sorcery<BASEFONT COLOR=#68FCAD><br>+5% Lower Reagent Cost" );
 } 
	}
}