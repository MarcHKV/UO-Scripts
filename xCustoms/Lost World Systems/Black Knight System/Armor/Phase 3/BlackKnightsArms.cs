...
{
	public class BlackKnightsArmsiii : PlateArms
	{
		...
		[Constructable]
		public BlackKnightsArmsiii()
		{
			Weight = 1.0; 
            		Name = "<BASEFONT COLOR=#C201FD>Black Knight's Arms"; 
            		Hue = 1175;
		...
		public BlackKnightsArmsiii( Serial serial ) : base( serial )
		{
		}
